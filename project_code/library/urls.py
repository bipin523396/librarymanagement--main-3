...
# admin path moved to root urls, removed to avoid duplicate namespace
    ...
    path('admin-dashboard/delete-book/<str:book_id>/', views.delete_book, name='delete_book'),
...
# New backend routes
    ...
    path('cart/add/<str:id>/', views.add_to_cart, name='add_to_cart'),
    path('cart/', views.view_cart, name='view_cart'),
    path('wishlist/add/<str:id>/', views.add_to_wishlist, name='add_to_wishlist'),
    ...
    path('track-order/<str:delivery_id>/', views.track_order, name='track_order'),
