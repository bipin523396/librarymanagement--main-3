...
# New backend routes
    ...
    path('admin-dashboard/assign-delivery/<int:rental_id>/', views.assign_delivery, name='assign_delivery'),
    path('admin-dashboard/update-delivery/<int:delivery_id>/', views.update_delivery_status, name='update_delivery_status'),
